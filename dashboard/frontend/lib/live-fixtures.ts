...
const BASE_SAFETY: LiveSafetyPanel = {
  ...
  reconciliation: {
    ...
    issues: 0,
    unresolved: 0,
    required_symbols: ["SPY", "QQQ", "IWM", "DIA", "XLK", "XLF", "XLE", "XLV", "XLI", "XLP"],
  ...
  account_safety: {
    ...
    safe_to_trade: true,
    established: true,
    reason: "A complete reconciliation pass over all 10 required symbols is CLEAN.",
    source: "reconciliation",
    updated_at: "2026-09-08T13:29:00+00:00",
    detail: null,
  },
  service: {
    state: "NOT_INSTALLED",

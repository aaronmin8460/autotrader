...
account-level risk and combined exposure, per-book allocation limits, a shared
API budget, the final reconciliation scope, and dashboard V0.2. Equity V0.2
provides the seams and does not turn any of it on. Its own first real paper
order has not been submitted either, and that gate belongs to that phase.
